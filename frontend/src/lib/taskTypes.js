import { CheckSquare, Bug, Sparkles, BookOpen, TrendingUp, HelpCircle, Layers } from "lucide-react";
...
export const TASK_TYPES = [
  ...
  { value: "epic",        label: "Epic",         icon: Layers,      color: "text-purple-500 dark:text-purple-400",  bg: "bg-purple-500/15"   },
