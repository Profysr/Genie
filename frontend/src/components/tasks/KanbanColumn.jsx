...
import { Plus, ChevronLeft, CheckCircle, PlayCircle, Expand, Minimize2, ArrowRight } from "lucide-react";
              ...
              >
                {isReceiving ? (
                  ...
                  <div className="flex items-center gap-1.5 flex-1 min-w-0">
                    ...
                    />
                    <span className="text-[10px] font-bold uppercase tracking-wider truncate" style={{ color: column.color }}>
                      {column.name}
                    </span>
                  </div>
                ) : (
